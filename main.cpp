...
int main()
{
    ...
    Node<double> *node_double1= new Node<double>(1.1);
    Node<double> *node_double2= new Node<double>(2.2);
    Node<double> *node_double3= new Node<double>(3.3);
    Node<double> *node_double4= new Node<double>(4.4);
    Node<double> *node_double5= new Node<double>(5.5);
    ...
    Node<int> *node_int1 = new Node<int>(1);
    Node<int> *node_int2 = new Node<int>(2);
    Node<int> *node_int3 = new Node<int>(3);
    Node<int> *node_int4 = new Node<int>(4);
    Node<int> *node_int5 = new Node<int>(5);
    Node<int> *node_int6 = new Node<int>(6);
    Node<int> *node_int7 = new Node<int>(7);
    Node<int> *node_int8 = new Node<int>(8);
    Node<int> *node_int9 = new Node<int>(9);
    ...
    Node<string> *node_str1 = new Node<string>("chanan");
    Node<string> *node_str2 = new Node<string>("hello");
    Node<string> *node_str3 = new Node<string>("world");
    Node<string> *node_str4 = new Node<string>("this");
    Node<string> *node_str5 = new Node<string>("is");
    Node<string> *node_str6 = new Node<string>("a");
    Node<string> *node_str7 = new Node<string>("gui");
    Node<string> *node_str8 = new Node<string>("for");
    Node<string> *node_str9 = new Node<string>("the");
    Node<string> *node_str10= new Node<string>("tree");
    ...
    Tree <int> tree_alloc; // declearing the tree before the nodes
    Node<int> *node11 = new Node<int>(11);
    Node<int> *node22 = new Node<int>(22);
    Node<int> *node33 = new Node<int>(33);
    Node<int> *node44 = new Node<int>(44);
    Node<int> *node55 = new Node<int>(55);
    Node<int> *node66 = new Node<int>(66);
    Node<int> *node77 = new Node<int>(77);
    Node<int> *node88 = new Node<int>(88);

    tree_alloc.add_root(node11);
    tree_alloc.add_sub_node(node11, node22);
    tree_alloc.add_sub_node(node11, node33);
    tree_alloc.add_sub_node(node22, node44);
    tree_alloc.add_sub_node(node22, node55);
    tree_alloc.add_sub_node(node33, node66);
    tree_alloc.add_sub_node(node33, node77);
    tree_alloc.add_sub_node(node44, node88);

    cout << "Looping BFS for int with 2 children:" << endl;
    for (auto it = tree_alloc.begin_BFS(); it != tree_alloc.end_BFS(); ++it)
    {
        cout << (it)->get_value() << " ";
    }
    cout << endl;

    cout << "Looping DFS for int with 2 children:" << endl;
    for (auto it = tree_alloc.begin_DFS(); it != tree_alloc.end_DFS(); ++it)
    {
        cout << (it)->get_value() << " ";
    }
    cout << endl;

    cout << "Looping Pre order for int with 2 children:" << endl;
    for (auto it = tree_alloc.begin_pre_order(); it != tree_alloc.end_pre_order(); ++it)
    {
        cout << (it)->get_value() << " ";
    }
    cout << endl;

    cout << "Looping In order for int with 2 children:" << endl;
    for (auto it = tree_alloc.begin_in_order(); it != tree_alloc.end_in_order(); ++it)
    {
        cout << (it)->get_value() << " ";
    }
    ...
    cout << "Looping Post order for int with 2 children:" << endl;
    for (auto it = tree_alloc.begin_post_order(); it != tree_alloc.end_post_order(); ++it)
    {
        cout << (it)->get_value() << " ";
    }
    ...
    cout << "Looping Tree to Heap for int with 2 children:" << endl;
    for (auto it = tree_alloc.begin_TreeToHeap(); it != tree_alloc.end_TreeToHeap(); ++it)
    {
        cout << (it)->get_value() << " ";
    }
    ...
    cout << tree_alloc << endl; // the gui is cuasing memory leak
